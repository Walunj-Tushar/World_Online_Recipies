  ...
  <body>
	...
	<div class="container">
	 <div class="title text-center brder">
					<h1 class="mb-10" style=""><i class="fa fa-user">&nbsp;RECIPIES DETAILS</h1></i>
				</div>
			</div>
	</div>
...
String sql ="select * from addrecipe";
...
<%String s="1"; %>
   <% if ( resultSet.getString("Status").equals(s) ) { %> 
   	<font  color="Green">	<i class="fa fa-unlock"></i>SHOW</font>
   		
   <% } else { %>
   	<font  color="red">	<i class="fa fa-unlock"></i>HIDE</font>
    		 <% } %>
  </td>
		<td><a href="ActiveRecipe.jsp?id=<%=resultSet.getString("Id") %>"><u><font  color="green"> SHOW</font></u></a><br>
        		 
<a href="DectiveRecipe.jsp?id=<%=resultSet.getString("Id") %>"><u><font  color="red"> HIDE</font></u></a>   
