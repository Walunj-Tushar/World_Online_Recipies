...
public class UserRegistration extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		try {
			...
			int r = st.executeUpdate("INSERT INTO `worldrecipes`.`usersregistration` (`FirstName`, `MiddleName`, `LastName`,`Address`,`Gender`, `Contact`, `Email`,`Password`,`ConfirmPassword`) VALUES ( '"
					+ FirstName
					+ "','"
					+ MiddleName
					+ "','"
